...
const video = "part=snippet&playlistId=PLYJgWBFYX7uMoGGBVoq7SorftyhSaWJ6L&maxResults=10&key="
...
const Maniac = () => {
  ...
  const [video, setVodeo] = useState(`https://www.youtube.com/embed/OvioeS1ZZ7o`)
  useEffect(() => {
    fetch(fetchUrl)
